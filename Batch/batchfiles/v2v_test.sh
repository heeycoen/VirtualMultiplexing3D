...
PYTHON_SCRIPT="/hpc/pmc_rios/1.projects/CK1_VirtualMultiplexing/2.experiments/VirtualMultiplexing/test.py"
...
echo "python ${PYTHON_SCRIPT} --c configs/train_conf_6.yml"
python ${PYTHON_SCRIPT} --c configs/train_conf_6.yml
